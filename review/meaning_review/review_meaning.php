...
{
$_SESSION['left']=$start;
$_SESSION['middle']=$start+1;
$_SESSION['right']=$start+2;
$l=$_SESSION['left'];
$m=$_SESSION['middle'];
$r=$_SESSION['right'];
}
...
<a href="dec_meaning.php"><img src="../../images/rev_arrow.png" <?php if($start==1) echo "style='display:none;'";  ?>></a>
  </div>
...
<a href="inc_meaning.php"><img src="../../images/rev_arr.png" <?php if($e>=$n) echo "style='display:none;'";  ?>></a>
  </div>
...
window.location.href="compute_rev_meaning.php?i="+x; 
 }
</script>
</body>
</html>
