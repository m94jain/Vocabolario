...
<body style="background:url(../../images/4.png);">
  ...
  <nav class="menu slide-menu-left">
    ...
    <div style="height:475px; width:94%; float:left; font-family:'Puritan';  ">
        <div id="f1_container" style="float:left;">
            <div id="f1_card" class="shadow" >
              ...
              <tr>
                ...
                <td height="30" width="70%" style="font-size:17px; font-weight:500; align:right;"><?php echo $synonym[0];?></td>
              </tr>
              <tr>
                <td height="42" width="30%" style="font-size:18px;"><?php echo $word[1];?> -</td>
                <td height="42" width="70%" style="font-size:17px; font-weight:500; align:justify;"><?php echo $synonym[1];?></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td height="42" width="70%" style="font-size:17px; font-weight:500; align:justify;"><?php echo $synonym[6];?></td>
              </tr>
              <tr>
        ...
        <form action="review_synonym.php" method="POST" style="margin-top:475px; ">
        <input type="submit" name="home" value="done" style="margin-left:50px;">
      </form>
    </div>
