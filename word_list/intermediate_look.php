...
$word_list= mysql_query( "SELECT * FROM $uniqueid where ((asked<5 AND (rightans/asked)>0.6) AND asked>0) OR (asked>5 AND ((rightans/asked)>0.6 AND (rightans/asked<0.8))) ");
  ...
  <nav class="menu slide-menu-left">
    ...
    <div style="height:475px; width:94%; float:left; font-family:'Puritan';  ">
      <div id="prev_button" style="float:left; width:450px; height:475px;">
        <form action="intermediate_compute_dec.php" method="POST" style="margin-top:255px; float:right;" >
            ...
            <div id="f1_card" class="shadow" >
                ...
                <div class="face" id="change1" >
                  <table  style="width:100% ; margin-left:20px; font-size:25px; font-family:'Cabin Condensed';">
                        <tr>
                <td height="48" width="2%"><?php if(strcmp("0",$word[0])!=0)echo $k+1,".";?></td><td height="48" width="98%"> <?php if(strcmp("0",$word[0])!=0){echo $word[0];}
                ?></td>
              </tr> 
                        <tr>
        ...
        <form action="intermediate_compute.php" method="POST" style="margin-top:255px;">
...
window.location.href="compute_int.php?i="+x; 
 }
</script>
